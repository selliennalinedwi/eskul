...
{
    public string $fromEmail  = 'noreply@ekskul-online.com';
    public string $fromName   = 'Ekskul Online System';
     ...
     */
    public string $SMTPHost = getenv('email.SMTPHost') ?: 'smtp.gmail.com';
